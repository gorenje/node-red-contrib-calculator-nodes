module.exports = function(RED) {
  function CoreMinusNodeFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("minusnode.label.statusset") });
  ...
  RED.nodes.registerType("MinusNode", CoreMinusNodeFunctionality);
