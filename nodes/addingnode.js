module.exports = function(RED) {
  function CoreAddingNodeFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("addingnode.label.statusset") });

        // Send a message and how to handle errors.
        try {
          try {

            msg.payload = msg.payload + msg.factor
  ...
  RED.nodes.registerType("AddingNode", CoreAddingNodeFunctionality);
